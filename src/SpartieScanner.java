...
public class SpartieScanner {
    ...
    private Token getSingleCharacterToken() {
        ...
        if (singleCharTokens.containsKey(nextCharacter)) {
            TokenType CharType = singleCharTokens.get(nextCharacter);
            current++;
            return new Token(CharType, String.valueOf(nextCharacter), line);
        }
